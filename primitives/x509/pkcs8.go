...
func ParsePKCS8PrivateKey(der []byte) (key interface{}, err error) {
	...
	case privKey.Algo.Algorithm.Equal(oidPublicKeyECDSA):
		...
		if _, uerr := asn1.Unmarshal(bytes, namedCurveOID); uerr != nil {
			namedCurveOID = nil
		}
		...
		key, err = parseSMPrivateKey(privKey.PrivateKey)
		if err == nil {
			return key, nil
		}
...
func MarshalPKCS8PrivateKey(key crypto.Signer) ([]byte, error) {
	...
	case *gm.SM2PrivateKey:
		...
		if privKey.PrivateKey, err = marshalSMPrivateKey(k); err != nil {
