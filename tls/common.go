...
//TODO use right curveID
//curve
const (
	CurveGMP256 CurveID = 233
...
const (
	...
	//TODO use right number
	SM2WithSM3 SignatureScheme = 0x0703
)
...
var defaultCurvePreferences = []CurveID{CurveGMP256, X25519, CurveP256, CurveP384, CurveP521}
...
type Certificate struct {
	...
	// initialized using gmx509.ParseCertificate to reduce per-handshake
...
func initDefaultCipherSuites() {
	...
	if hasGCMAsm {
		...
		topCipherSuites = []uint16{
			GMTLS_SM2DHE_SM2SIGN_WITH_SMS4_SM3,
